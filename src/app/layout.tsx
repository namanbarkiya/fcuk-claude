...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        images: [
            {
                url: "https://res.cloudinary.com/dvt5vkfwz/image/upload/v1774350760/fcuk_claude_og_tpgkxf.jpg",
                width: 1200,
                height: 630,
                alt: "fcuk claude",
            },
    ...
    twitter: {
        ...
        images: [
            "https://res.cloudinary.com/dvt5vkfwz/image/upload/v1774350760/fcuk_claude_og_tpgkxf.jpg",
        ],
    },
};
